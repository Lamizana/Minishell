...
#    Updated: 2023/02/02 11:40:04 by alamizan         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
- REGLES:
-> Compilation:
	- valgrind --leak-check=full --show-leak-kinds=all --suppressions=vsupp ./a.out
...
-------------------------------------------------------------------------------
	...
	- Blog 				--> Pays du 42.
	- Conference 42sh 	--> architecture d un shell.
-------------------------------------------------------------------------------
